...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_Y_POS          250         // (mm) Y position of the toolhead dock
  #define SWITCHING_TOOLHEAD_Y_SECURITY      10         // (mm) Security distance Y axis
  #define SWITCHING_TOOLHEAD_Y_CLEAR         60         // (mm) Minimum distance from dock for unobstructed X axis
  #define SWITCHING_TOOLHEAD_X_POS          { 250, 0 }  // (mm) X positions for parking the extruders
...
#define PIDTEMP
#define BANG_MAX 270     // Limits current to nozzle while in bang-bang mode; 255=full current
 ...
 */
//#define Z_MIN_PROBE_PIN GND // Pin 32 is the RAMPS default
 ...
 *                and a minimum Z_HOMING_HEIGHT of 5.
 */
//#define TOUCH_MI_PROBE
#if ENABLED(TOUCH_MI_PROBE)
  #define TOUCH_MI_RETRACT_Z 0.2                  // Height at which the probe retracts
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      79    // (°C) Default bed temperature for G26.
...
//#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  0.20 // (mm) Step size while manually probing Z axis.
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 360
  #define XY_DIAG_BD 360
  #define XY_SIDE_AD 250
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 360
    #define XZ_DIAG_BD 360
    #define YZ_DIAG_AC 360
    #define YZ_DIAG_BD 360
    #define YZ_SIDE_AD 250
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_MIN_TEMP 230
